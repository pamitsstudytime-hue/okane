      ...
      {!hideSearchButton && (
        <button
          ...
          style={{
            ...
            border: '1px solid var(--accent-border-soft, rgba(255, 255, 255, 0.18))',
            boxShadow: '0 8px 24px -4px rgba(0, 0, 0, 0.45), 0 2px 8px rgba(0, 0, 0, 0.3)',
            display: 'flex',
            alignItems: 'center',
      ...
      {hasAIAssistant && onAIClick && (
        <button
          ...
          style={{
            ...
            color: 'var(--accent-contrast)',
            border: '1px solid var(--accent-border-soft, rgba(255, 255, 255, 0.18))',
            boxShadow: '0 8px 24px -2px rgba(0, 0, 0, 0.45), 0 2px 8px rgba(0, 0, 0, 0.3)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            cursor: 'pointer',
